        ...
        for current_task_id, task in enumerate(tasks):
            try:
                ...
                for x in imgs:
                    ...
                    # log(x, d, single_line_number=3) #Don't bother saving images to disk as this is mostly meant for colab
                    #The images are already saved in temp output for the gradio hosting
